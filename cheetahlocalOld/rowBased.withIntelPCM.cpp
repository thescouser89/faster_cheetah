...
int main(int argc, char *argv[]) {
	...
	PCM::CustomCoreEventDescription MyEvents[12]; // only 4 fully programmable counters are supported on microarchitecture codenamed Nehalem/Westmere
	MyEvents[0].event_number = 0x24;
	MyEvents[0].umask_value = 0x01;
	MyEvents[1].event_number = 0x24;
	MyEvents[1].umask_value = 0x03;
	MyEvents[2].event_number = 0x51;
	MyEvents[2].umask_value = 0x01;
	MyEvents[3].event_number = 0x51;
	MyEvents[3].umask_value = 0x04;
	MyEvents[4].event_number = 0x51;
	MyEvents[4].umask_value = 0x08;
	MyEvents[5].event_number = 0xF0;
	MyEvents[5].umask_value = 0x01;
	MyEvents[6].event_number = 0xF2;
	MyEvents[6].umask_value = 0x01;
	MyEvents[7].event_number = 0xF2;
	MyEvents[7].umask_value = 0x04;
	MyEvents[8].event_number = 0x08;
	MyEvents[8].umask_value = 0x01;
	MyEvents[9].event_number = 0x08;
	MyEvents[9].umask_value = 0x02;
	MyEvents[10].event_number = 0x08;
	MyEvents[10].umask_value = 0x04;
	MyEvents[11].event_number = 0x08;
	MyEvents[11].umask_value = 0x10;
	...
	for (int i = 0; i < numRows; i++) {
		if (db[(i * numCols) + A_col_id] <= selectivity) {
			curRowindex = (i * numCols);
			for (int colId = 0; colId < numCols; colId++) {
				sum += db[curRowindex + colId];
			}
		}
	}
	// End of the query
