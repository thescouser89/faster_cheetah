...
//                        System.out.print((end - start)+" ");
    ...
    public static void main(String[] args) throws IOException{
        ...
        for(String query: runTimes.keySet()){
			...
			if(storeMethod.equals("RowStoreEng")){
				System.out.print(queryfile.replace("query/query_", "")+"|selectivity:"+ sel + "%|RowStore|");
				...
				System.out.print(queryfile.replace("query/query_", "")+"|selectivity:"+ sel + "%|ColStore|");
                System.out.print(runTimes.get(query).get(0));
                for(int i=1; i<runTimes.get(query).size(); i++){
                    System.out.print(" "+runTimes.get(query).get(i));
                }
				...
				System.out.print(queryfile.replace("query/query_", "")+"|selectivity:"+ sel + "%|RowColStore-" + temp2[temp2.length - 1] + "|");
                System.out.print(runTimes.get(query).get(0));
                for(int i=1; i<runTimes.get(query).size(); i++){
                    System.out.print(" "+runTimes.get(query).get(i));
                }
