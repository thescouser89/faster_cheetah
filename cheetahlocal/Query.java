...
public class Query {
	...
	//	0	: empty query
	//	1	: select only 
	//	2	: select where equal
	//	3	: select where range 
	//	4	: select where any
	//	10	: aggregate
	//	11	: select only aggregation
	//	13	: aggregate where range, group by
	//	50	: insert
...
/*//This used to be subclass of SimpleQueryExecutor
public class Query extends Thread {
    ...
    Query(int threadId, StoreEngine store, String queryString){
        this.type = 0;
