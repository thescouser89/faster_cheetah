...
public class RowColStoreSelectTest {
    public static void main(String[] args){
        ...
        if (args.length != 3){
            System.out.println("Arguments: "+ "<input file name> <input layout file> <select columns separated by : >" );
            System.exit(0);
        }
		...
		try{
            ...
            for(int i=0; i<numTests; i++){
                ...
                long sum=rowColStore.select(columns); 
