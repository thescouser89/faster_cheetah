...
public class ColStoreSelectTest {
    public static void main(String[] args){
        ...
        if (args.length != 2){
            System.out.println("Arguments: "+ "<input file name> <select columns separated by ：>" );
            System.exit(0);
        }
	
		ColStoreEng colStore = new ColStoreEng(buffer_size);
		...
		try{
            ...
            for(int i=0; i<numTests; i++){
                ...
                long sum = colStore.select(columns); 
                long end = System.currentTimeMillis();
                System.out.print(sum+" ");
				System.out.println(end-start);
				start = System.currentTimeMillis();
                //sum = colStore.fastSelect(columns); 
