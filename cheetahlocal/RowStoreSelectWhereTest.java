...
public class RowStoreSelectWhereTest {
    public static void main(String[] args){
        ...
        if (args.length != 5){
            System.out.println("Arguments: "+ "<input file name> <input column def file name> <select columns separated by : > <where column name> <threshold>" );
            System.exit(0);
        }
		...
		try{
            ...
            for(int i=0; i<numTests; i++){
                ...
                long sum=rowStore.selectWhere(columns, args[3].getBytes(), Integer.parseInt(args[4])); 
